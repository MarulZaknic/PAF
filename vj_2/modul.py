...
def jed_gibanje(masa, sila):
    ...
    plt.plot(v_vrijednosti, t_vrijednosti, label='Continuous Line')
    ...
    plt.plot(p_vrijednosti, t_vrijednosti, label='Continuous Line')
    ...
    plt.plot(a_vrijednosti, t_vrijednosti, label='Continuous Line')
